   ...
   """
    ...
    def unique_spriterow_nums(self):
        ...
        for unit in set([unit.spriterow_num for unit in self.units]):
            result.append(unit)
            # extend with any cc_liveries, spritesheet format assumes unit_1_default, unit_1_cc_livery_1, unit_1_cc_livery_2, unit_2_default..unit_1_cc_livery_2 etc
            for counter, cc_livery in enumerate(getattr(self.gestalt_graphics, 'cc_liveries', [])):
                result.append(unit + counter + 1)
        return result
    ...
    def intro_date_days_offset(self):
        ...
        role_to_role_groups_mapping = {'express_core': {'express': [1], 'heavy_express': [1]},
                                       ...
                                       'hst': {'hst': [1]},
                                       'jokers': {'gronk!': [-1, -2], 'express': [-1], 'heavy_express': [-1, -2, -3], 'freight': [-1, -2], 'heavy_freight': [-1, -2, -3], 'snoughplough!': [-1]},
...
class EngineConsist(Consist):
    ...
    def __init__(self, **kwargs):
        ...
        # cc_liveries is populated from presets defined on the roster
        cc_liveries = []
