...
class BolsterCarConsist(CarConsist):
    ...
    def __init__(self, **kwargs):
        ...
        self.randomised_candidate_groups = [
            "randomised_mixed_metal_product_car",
            "randomised_uncovered_metal_product_car",
        ]
        self._joker = True
        # Graphics configuration
...
class CoilCarCoveredAsymmetricConsist(CoilCarConsistBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.randomised_candidate_groups = [
            ...
            "randomised_covered_metal_product_car",
            "randomised_mixed_metal_product_car",
        ]
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
...
class MetalProductCarRandomisedConsistBase(RandomisedConsistMixin, CoilCarConsistBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.use_named_buyable_variant_group = (
            "wagon_group_randomised_metal_product_cars"
        )
        # Graphics configuration
        self.gestalt_graphics = GestaltGraphicsRandomisedWagon(
            dice_colour=2,
...
class MetalProductCarCoveredRandomisedConsist(MetalProductCarRandomisedConsistBase):
    ...
    def __init__(self, **kwargs):
        self.base_id = "randomised_covered_metal_product_car"
        super().__init__(**kwargs)
...
class MetalProductCarMixedRandomisedConsist(MetalProductCarRandomisedConsistBase):
    ...
    def __init__(self, **kwargs):
        self.base_id = "randomised_mixed_metal_product_car"
        super().__init__(**kwargs)
...
class MetalProductCarUncoveredRandomisedConsist(MetalProductCarRandomisedConsistBase):
    ...
    def __init__(self, **kwargs):
        self.base_id = "randomised_uncovered_metal_product_car"
        super().__init__(**kwargs)
...
class CoveredHopperCarChemicalConsist(CoveredHopperCarConsistBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.randomised_candidate_groups = ["randomised_chemical_covered_hopper_car"]
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
        self.use_named_buyable_variant_group = (
...
class CoveredHopperCarChemicalRandomisedConsist(
    ...
    def __init__(self, **kwargs):
        self.base_id = "randomised_chemical_covered_hopper_car"
        super().__init__(**kwargs)
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
        self.use_named_buyable_variant_group = (
...
class DumpCarAggregateConsistType4(DumpCarConsistBase):
    """
    Aggregate Car.
    Same as standard dump car, but different appearance and default cargos.
    """
    ...
    def __init__(self, **kwargs):
        self.base_id = "aggregate_dump_car_type_4"
        super().__init__(**kwargs)
        self.default_cargos = polar_fox.constants.default_cargos["dump_aggregates"]
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
...
class DumpCarAggregateConsistType6(DumpCarConsistBase):
    """
    Aggregate Car.
    Same as standard dump car, but different appearance and default cargos.
    """
    ...
    def __init__(self, **kwargs):
        self.base_id = "aggregate_dump_car_type_6"
        super().__init__(**kwargs)
        self.default_cargos = polar_fox.constants.default_cargos["dump_aggregates"]
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
...
class PieceGoodsCarRandomisedConsistBase(RandomisedConsistMixin, CarConsist):
    ...
    def __init__(self, **kwargs):
        ...
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
        self.use_named_buyable_variant_group = "wagon_group_randomised_piece_goods_cars"
        self._joker = True
...
class PieceGoodsCarMixedRandomisedConsist(PieceGoodsCarRandomisedConsistBase):
    ...
    def __init__(self, **kwargs):
        self.base_id = "randomised_mixed_piece_goods_car"
        super().__init__(**kwargs)
        # Graphics configuration
        self.gestalt_graphics = GestaltGraphicsRandomisedWagon(
            dice_colour=3,
...
class TankCarAcidConsistBase(TankCarConsistBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.randomised_candidate_groups = [
            "randomised_chemical_tank_car",
            "randomised_acid_tank_car",
        ]
        # buyable variant groups are created post-hoc and can group across subclasses
        # any buyable variants (liveries) within the subclass will be automatically added to the group
...
class TankCarAcidConsistType1(TankCarAcidConsistBase):
    ...
    def __init__(self, **kwargs):
        ...
        # Graphics configuration
        weathered_variants = {
            "unweathered": graphics_constants.acid_tank_car_type_1_livery_recolour_maps,
            "weathered": graphics_constants.acid_tank_car_type_1_livery_recolour_maps_weathered,
        }
        self.gestalt_graphics = GestaltGraphicsSimpleBodyColourRemaps(
            weathered_variants=weathered_variants,
            liveries=[
...
class TankCarAcidConsistType2(TankCarAcidConsistBase):
    ...
    def __init__(self, **kwargs):
        ...
        # Graphics configuration
        weathered_variants = {
            "unweathered": graphics_constants.acid_tank_car_type_2_livery_recolour_maps,
            "weathered": graphics_constants.acid_tank_car_type_2_livery_recolour_maps_weathered,
        }
        self.gestalt_graphics = GestaltGraphicsSimpleBodyColourRemaps(
            weathered_variants=weathered_variants,
            liveries=[
...
class TankCarAcidRandomisedConsist(RandomisedConsistMixin, TankCarAcidConsistBase):
    ...
    def __init__(self, **kwargs):
        self.base_id = "randomised_acid_tank_car"
        super().__init__(**kwargs)
        # Graphics configuration
        self.gestalt_graphics = GestaltGraphicsRandomisedWagon(
            dice_colour=3,
