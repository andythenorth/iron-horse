...
class EngineConsist(Consist):
    ...
    def __init__(self, **kwargs):
        ...
        self.caboose_families = self.roster.caboose_default_family_by_generation[self.base_track_type][self.gen - 1]
        # caboose families can be over-ridden on a per engine, per caboose type basis
        for caboose_type, family_name in kwargs.get('force_caboose_families', {}).items():
...
class CabooseCarConsistBase(CarConsist):
    ...
    def __init__(self, **kwargs):
        ...
        self.spriterow_labels = ["test", "cabbage1", "test2", "toad_test"]
        # Graphics configuration
