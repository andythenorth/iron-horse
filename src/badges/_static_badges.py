...
static_badges = {
    ...
    # many _ih_formation_ruleset badges are provided by catalogues, but a handful must be provided even for rosters that don't contain any vehicles using the relevant badge
