...
class IntermodalContainerSpritelayerCargo(object):
    """ Base class for container spritelayer cargos """
...
class IntermodalBaseDefaultAndLowFloor(IntermodalContainerSpritelayerCargo):
...
class IntermodalBaseCargoSprinter(IntermodalContainerSpritelayerCargo):
    """ Sparse base class to set compatible platform types and sprite placement template """
