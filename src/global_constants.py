...
wagon_module_names = [
    ...
    "randomised_uncovered_metal_product_cars",
    "randomised_covered_metal_product_cars",
    "randomised_mixed_metal_product_cars",
    "hopper_cars",
    ...
    "scrap_metal_cars",
    "skip_cars",
    "randomised_box_bulk_cars",
    "randomised_hopper_bulk_cars",
    "randomised_mixed_bulk_cars",
    "tank_cars",
    "product_tank_cars",
    ...
    "randomised_chemical_covered_hopper_cars",
    ...
    "randomised_farm_product_hopper_cars",
    "log_cars",
    "kaolin_hopper_cars",
...
buyable_variant_group_consist_base_ids_by_group_name = {
    ...
    "wagon_group_farm_product_cars": "farm_product_hopper_car_type_1",
    ...
    "wagon_group_randomised_bulk_cars": "randomised_mixed_bulk_car",
    "wagon_group_randomised_metal_product_cars": "randomised_mixed_metal_product_car",
    "wagon_group_randomised_piece_goods_cars": "randomised_mixed_piece_goods_car",
