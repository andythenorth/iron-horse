...
wagon_module_name_stems = [
    ...
    "mineral_covered_hopper_cars_type_2",
    "mineral_covered_hopper_cars_type_3",
    "mineral_covered_hopper_cars_randomised",
...
buyable_variant_group_consist_base_ids_by_group_name = {
    ...
    "wagon_group_mineral_covered_hopper_cars": "mineral_covered_hopper_car_type_1",
