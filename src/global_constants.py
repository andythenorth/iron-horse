...
default_spritesheet_offsets = {'3': [[-3, -25], [-3, -21], [0, -12], [5, -17], [-3, -14], [-14, -17], [-16, -12], [-8, -23]], # not used?
                               ...
                               '5': [[-3, -22], [-6, -19], [0, -12], [1, -16], [-3, -14], [-16, -16], [-16, -12], [-8, -21]], # not used?
                               '6': [[-3, -16], [-10, -18], [-8, -12], [-4, -16], [-3, -14], [-14, -16], [-16, -12], [-8, -19]], # mostly correct May 2018
                               '7': [[-3, -20], [-8, -18], [0, -12], [-1, -15], [-3, -14], [-17, -15], [-16, -12], [-10, -19]], # not used?
                               '8': [[-3, -16], [-14, -15], [-16, -12], [-7, -16], [-3, -16], [-13, -16], [-16, -12], [-7, -16]]} # mostly correct May 2018
