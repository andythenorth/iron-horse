...
graphics_temp_storage = dict(var_id_of_neighbouring_vehicle = 0, # used only to work around not being able to return an expression from a procedure, but being able to return LOAD_TEMP()
