...
def main(**kwargs):
    ...
    model_def = ModelDef(
        ...
        replacement_model_id="intrepid",  # this Joker ends with Intrepid, long-lived
    ...
    model_def.add_unit_def(
        class_name="SteamEngineTenderUnit", weight=30, vehicle_length=4, rel_spriterow_index=1
    )
