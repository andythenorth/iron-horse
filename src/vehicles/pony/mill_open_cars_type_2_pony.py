...
def main(**kwargs):
    ...
    model_def = ModelDef(
        schema_name="OpenCarMillType2",
        base_numeric_id=27250,
        gen=3,
        subtype="A",
        base_track_type="NG",
    ...
    model_def = ModelDef(
        schema_name="OpenCarMillType2",
        base_numeric_id=26850,
        gen=4,
        subtype="C",
        sprites_complete=True,
    )

    model_def.add_unit_def(unit_cls_name="FreightCarUnit", chassis="4_axle_gapped_inset_32px")
