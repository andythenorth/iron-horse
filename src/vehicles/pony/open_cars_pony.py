...
def main(**kwargs):
    ...
    model_def.add_unit(class_name="FreightCar", chassis="2_axle_metro_16px", repeat=2)
    ...
    model_def.add_unit(class_name="FreightCar", chassis="4_axle_metro_32px")
    ...
    model_def.add_unit(class_name="FreightCar", chassis="4_axle_filled_32px")
