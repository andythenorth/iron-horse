...
def main(**kwargs):
    ...
    model_def.add_unit_def(
        class_name="DieselEngineUnit", weight=68, vehicle_length=5, rel_spriterow_index=0
    )

    model_def.add_unit_def(
        class_name="DieselEngineUnit", weight=68, vehicle_length=5, rel_spriterow_index=1
    )
