...
def main(**kwargs):
    ...
    model_def.add_unit_def(class_name="ExpressCar", chassis="3_axle_solid_express_16px")
    ...
    model_def.add_unit_def(class_name="ExpressCar", chassis="4_axle_solid_express_24px")
    ...
    model_def.add_unit_def(class_name="ExpressCar", chassis="4_axle_solid_express_32px")
    ...
    model_def.add_unit_def(class_name="ExpressCar", chassis="2_axle_solid_express_16px")
