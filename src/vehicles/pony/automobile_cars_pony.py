...
def main(**kwargs):
    ...
    model_def.add_unit_def(
        unit_cls_name="AutomobileCarSymmetricUnit", chassis="3_axle_solid_express_16px"
    )
    ...
    model_def.add_unit_def(
        unit_cls_name="AutomobileCarSymmetricUnit", chassis="4_axle_solid_express_32px"
    )
    ...
    model_def.add_unit_def(
        unit_cls_name="AutomobileCarSymmetricUnit", chassis="2_axle_filled_24px"
    )
    ...
    model_def.add_unit_def(
        unit_cls_name="AutomobileCarSymmetricUnit",
    ...
    model_def.add_unit_def(
        unit_cls_name="AutomobileCarAsymmetricUnit",
        chassis="2_axle_filled_greebled_20px",
        rel_spriterow_index=0,
    )
