...
def main(roster_id, **kwargs):
    ...
    consist_factory.add_unit(type=FreightCar, chassis="4_axle_1cc_filled_hopppers_24px")
    ...
    consist_factory.add_unit(type=FreightCar, chassis="4_axle_1cc_filled_hoppers_32px")
