...
def main(**kwargs):
    ...
    model_def = ModelDef(
        ...
        liveries=["BANGER_BLUE", "STOCK_STANDARD", "SHOW_PONY", "CONVENTIONAL_WISDOM", "FREIGHT_BLACK", "WORKER_BEE", "INDUSTRIAL_YELLOW"],
    ...
    model_def_clone = model_def.begin_clone(base_numeric_id=600, unit_repeats=[1])
