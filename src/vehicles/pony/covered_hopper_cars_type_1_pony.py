...
def main(**kwargs):
    ...
    model_def.add_unit(class_name="FreightCar", chassis="2_axle_chute_16px")
    ...
    model_def.add_unit(class_name="FreightCar", chassis="2_axle_chute_greebled_16px")
    ...
    model_def.add_unit(class_name="FreightCar", chassis="2_axle_chute_greebled_24px")
