...
def main(roster_id, **kwargs):
    ...
    consist_factory.add_unit(class_name="CabbageDVTUnit", weight=34, chassis="railcar_32px")
    ...
    consist_factory.foamer_facts = """CAF MK5A Driving Van Trailer (DVT) with added generator"""
