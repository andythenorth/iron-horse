...
def main(**kwargs):
    ...
    model_def.add_unit(class_name="PaxCar", chassis="4_axle_ng_16px")
    ...
    model_def.add_unit(class_name="PaxCar", chassis="4_axle_ng_24px")
    ...
    model_def.add_unit(class_name="PaxCar", chassis="4_axle_ng_32px")
    ...
    model_def.add_unit(class_name="PaxCar", chassis="2_axle_solid_express_16px")
