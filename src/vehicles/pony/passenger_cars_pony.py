...
def main(**kwargs):
    ...
    model_type_factory.define_unit(class_name="PaxCar", chassis="4_axle_ng_16px")
    ...
    model_type_factory.define_unit(class_name="PaxCar", chassis="4_axle_ng_24px")
    ...
    model_type_factory.define_unit(class_name="PaxCar", chassis="4_axle_ng_32px")
