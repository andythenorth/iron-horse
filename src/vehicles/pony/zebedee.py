...
def main(**kwargs):
    ...
    consist_factory.description = """These were heavy on the track, but we had em back and fitted extra springs."""
    consist_factory.foamer_facts = """BR Class 86 / Class 87"""
