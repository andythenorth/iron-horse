from train import SiloCarConsistType2, FreightCar
...
def main(roster_id, **kwargs):
    ...
    consist_factory = SiloCarConsistType2(
        roster_id=roster_id,
    ...
    consist_factory.add_unit(class_name="FreightCar", chassis="4_axle_filled_greebled_24px")
