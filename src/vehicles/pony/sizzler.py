...
def main(**kwargs):
    ...
    model_def.add_unit_def(
        class_name="ElectricEngineUnit", weight=82, vehicle_length=8, rel_spriterow_index=0
    )

    model_def.define_description("""Looks like a cheese to me, goes alright though.""")
