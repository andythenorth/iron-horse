...
class BulkOpenCarScrapMetalBase(BulkOpenCarBase):
    ...
    liveries = [
        ...
        "COMPLEMENT_COMPANY_COLOUR_USE_WEATHERING",
        "COMPANY_COLOUR_USE_WEATHERING",
        "FREIGHT_RUST", # CABBAGE merge RUBY AND RUST to RED RUST (use the weathered ruby, and a new rust shade), split out a grey variant of RUST also
...
class ExpressFoodCarRandomised(RandomisedCarMixin, ExpressFoodCarBase):
    """
    Random choice of food car sprite, noting limited refits because it includes food tankers.
    """
...
class TankCarVolatilesBase(TankCarBase):
    ...
    # more doesn't add anything here
    liveries = [
        "RANDOM_LIVERIES_COMPLEMENT_COMPANY_COLOUR",
        "RANDOM_LIVERIES_VARIETY_MUTED",
        "RANDOM_LIVERIES_RUBY_RUST", # CABBAGE - SWAP TO MIXED RUBY / PINK, ADD PINK / RED?
        "RANDOM_LIVERIES_GREY_PEWTER_SILVER_NO_WEATHERING",
        "RANDOM_LIVERIES_TEAL_PEWTER_SILVER",
        "RANDOM_LIVERIES_OIL_BLACK_OBSIDIAN",
        "COMPLEMENT_COMPANY_COLOUR_USE_WEATHERING",
        "COMPANY_COLOUR_USE_WEATHERING",
        "FREIGHT_RED", # CABBAGE - REMOVE - UNWEATHERED, REPLACE WITH PINK / RED
        "FREIGHT_RUST",
        "FREIGHT_TEAL",
    ]
...
class TarpaulinCarBase(BoxCarBase):
    ...
    liveries = [
        ...
        "COMPLEMENT_COMPANY_COLOUR_USE_WEATHERING",
        "COMPANY_COLOUR_USE_WEATHERING",
        "FREIGHT_RUST", # CABBAGE - USE MERGED RUST & FREIGHT_RUBY
        "FREIGHT_TEAL",
    ]
