...
dead_strings = [
    "STR_WAGON_NAME_AGGREGATE_BULK_OPEN_CAR_RANDOMISED",
    "STR_WAGON_NAME_AGGREGATE_HOPPER_CAR_RANDOMISED",
    "STR_WAGON_NAME_BOLSTER_CAR_RANDOMISED",
    "STR_WAGON_NAME_HIGH_END_BOLSTER_CAR",
]
