# Iron Horse converted lang sources from .lng files to .toml in August 2023
...
def main():
    ...
    # don't walk all the rosters, as the moose and ibex translation are likely inaccurate, as they were copied from pony and have never been updated
    for file_name in os.listdir(os.path.join("src", "lang", "pony")):
        if file_name != ".DS_Store":
            lng_file = codecs.open(
                os.path.join("src", "lang", "pony", file_name),
                "r",
                encoding="utf-8",
            )
