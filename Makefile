...
GRAPHICS_TARGETS = $(GRF_NAMES:%=generated/graphics/make_target_%)
...
# a pre-requisites list could actually be generated by python, but it's not proven necessary so far
	$(_V) $(PYTHON3) src/render_graphics.py $(PY_GLOBAL_ARGS) --grf-name=$(subst generated/graphics/make_target_,,$@)
	$(_V) touch $@
